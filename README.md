...
## 📌 Resumo do Projeto
> O projeto atende as demandas de um sistema de classificação de dígitos manuscritos (0–9) usando redes neurais convolucionais(CNNs) com o TensorFlow, treinado com o dataset MNIST para cumprir o desafio de Edge AI proposto pela plataforma do PNAAT.
